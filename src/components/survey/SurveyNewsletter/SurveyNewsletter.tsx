    ...
    <div className="flex flex-col justify-center ">
      ...
      <div className="  flex flex-col w-[340px] h-fit bg-[#D3D9DA] text-slate-800 rounded-2xl p-4 gap-[10px]">
        ...
        <p className=" font-normal  text-[#004554] w-[308px] h-[72px] flex items-center">
          Poznaj poglądy innych, porównaj się, zdobądź wiedzę o zmianach w
          społeczeństwie i Twoim otoczeniu!
        </p>
      </div>
      {/* input*/}
      <Input
      ...
      <div className=" flex flex-row w-[340px] h-fit gap-2">
        <Checkbox
          label=""
          className="w-[14px] h-[14px] bg-[#FFFFFF] border border-[#D3D9DA] rounded-[2px] cursor-pointer"
          checked={consent}
        ...
        <div className="text-[14px] leading-[120%] tracking-normal w-[318px] block text-slate-800">
          ...
          przesyłania mi treści marketingowych przez Fundację Generacja
          Innowacja.{" "}
          <a
            href="https://www.generacja-innowacja.org/polityka-prywatnosci"
            target="_blank"
            rel="noopener noreferrer"
            className=" text-[14px] leading-[120%] tracking-normal underline decoration-solid text-[#004554] cursor-pointer hover:opacity-80 transition-opacity"
          >
            {" "}
