    ...
    <div className="flex flex-col justify-center ">
      <div className="  flex flex-col w-[340px] h-fit bg-(--color-gi-dark-ash) text-slate-800 rounded-2xl p-4 gap-[10px]">
        ...
        <p className=" font-normal  text-(--color-gi-primary) w-[308px] h-[72px] flex items-center">
         <Trans id="Newsletter.Description" message="Poznaj poglądy innych, porównaj się, zdobądź wiedzę o zmianach w społeczeństwie i Twoim otoczeniu!" />
        </p>
      </div>
      <Input
        type="email"
      ...
      <div className=" flex flex-row w-[340px] h-fit gap-2">
        ...
        <div className="text-[14px] leading-[120%] tracking-normal w-[318px] block text-slate-800">
          <Trans id="Newsletter.Consent" message="Wyrażam zgodę na przetwarzanie moich danych osobowych w celu przesyłania mi treści marketingowych przez Fundację Generacja Innowacja." />
          <a
            href={PATHS.privacy}
            target="_blank"
          ...
          >
            <Trans id="Newsletter.PrivacyPolicy" message="Polityka prywatności." />
          </a>
          <br /> <br />
          <Trans id="Newsletter.DataUsage" message="Twoje dane osobowe nie będą w żaden sposób powiązane z wynikami." />
        </div>
      </div>
    </div>
  );
